...
<table>
  ...
  <tr>
    ...
    <td align="center">0.807 vs <b>0.812</b></td>
  </tr>
  <tr>
    ...
    <td align="center">0.521 vs <b>0.516</b></td>
  </tr>
  <tr>
    ...
    <td align="center">0.845 vs <b>0.833</b></td>
  </tr>
  <tr>
    ...
    <td align="center">0.753 vs <b>0.747</b></td>
  </tr>
  <tr>
    ...
    <td align="center">0.796 vs <b>0.788</b></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center">0.640 → <b>0.708</b> <sub>(+10.62%)</sub></td>
    <td align="center">0.615 vs <b>0.640</b></td>
  </tr>
  <tr>
...
|--------|---------:|----:|----:|----:|----:|:----------------------------:|:-------------:|:------------:|
| **mAP@50** | 0.530 | 0.562 (+6.04%) | 0.546 (+3.02%) | 0.540 (+1.89%) | 0.558 (+5.28%) | 0.590 (+11.32%) | 0.558 (+5.28%) | **0.608 (+14.72%)** |
| **mAP@50–95** | 0.297 | 0.322 (+8.42%) | 0.312 (+5.05%) | 0.305 (+2.69%) | 0.320 (+7.74%) | 0.355 (+19.53%) | 0.322 (+8.42%) | **0.372 (+25.25%)** |
| **Precision** | 0.748 | 0.792 (+5.88%) | 0.770 (+2.94%) | 0.762 (+1.87%) | 0.788 (+5.35%) | 0.859 (+14.84%) | 0.788 (+5.35%) | **0.872 (+16.58%)** |
| **Recall** | 0.658 | 0.702 (+6.69%) | 0.682 (+3.65%) | 0.672 (+2.13%) | 0.698 (+6.08%) | 0.783 (+19.00%) | 0.702 (+6.69%) | **0.802 (+21.88%)** |
| **F1-score** | 0.700 | 0.744 (+6.29%) | 0.723 (+3.29%) | 0.714 (+2.00%) | 0.740 (+5.71%) | 0.816 (+16.57%) | 0.742 (+6.00%) | **0.835 (+19.29%)** |
...
| Metric | Baseline | +A1 | +A2 | +A3 | +A4 | Custom Loss<br>(A1+A2+A3+A4) | +Architecture | 🏆 New Model |
|--------|---------:|----:|----:|----:|----:|:----------------------------:|:-------------:|:------------:|
| **mAP@50** | 0.750 | 0.770 (+2.67%) | 0.760 (+1.33%) | 0.765 (+2.00%) | 0.768 (+2.40%) | 0.804 (+7.20%) | 0.772 (+2.93%) | **0.818 (+9.07%)** |
| **mAP@50–95** | 0.424 | 0.443 (+4.48%) | 0.434 (+2.36%) | 0.440 (+3.77%) | 0.441 (+4.01%) | 0.477 (+12.50%) | 0.444 (+4.72%) | **0.494 (+16.51%)** |
| **Precision** | 0.821 | 0.844 (+2.80%) | 0.834 (+1.58%) | 0.840 (+2.31%) | 0.842 (+2.56%) | 0.900 (+9.62%) | 0.848 (+3.29%) | **0.912 (+11.08%)** |
| **Recall** | 0.735 | 0.760 (+3.40%) | 0.748 (+1.77%) | 0.756 (+2.86%) | 0.758 (+3.13%) | 0.825 (+12.24%) | 0.764 (+3.95%) | **0.842 (+14.56%)** |
| **F1-score** | 0.776 | 0.800 (+3.09%) | 0.789 (+1.68%) | 0.796 (+2.58%) | 0.798 (+2.84%) | 0.860 (+10.82%) | 0.804 (+3.61%) | **0.875 (+12.76%)** |
...
| Metric | Baseline | +A1 | +A2 | +A3 | +A4 | Custom Loss<br>(A1+A2+A3+A4) | +Architecture | 🏆 New Model |
|--------|---------:|----:|----:|----:|----:|:----------------------------:|:-------------:|:------------:|
| **mAP@50** | 0.828 | 0.845 (+2.05%) | 0.840 (+1.45%) | 0.848 (+2.42%) | 0.842 (+1.69%) | 0.865 (+4.47%) | 0.850 (+2.66%) | **0.874 (+5.56%)** |
| **mAP@50–95** | 0.550 | 0.572 (+4.00%) | 0.566 (+2.91%) | 0.576 (+4.73%) | 0.568 (+3.27%) | 0.597 (+8.55%) | 0.578 (+5.09%) | **0.604 (+9.82%)** |
| **Precision** | 0.846 | 0.866 (+2.36%) | 0.860 (+1.65%) | 0.870 (+2.84%) | 0.862 (+1.89%) | 0.901 (+6.50%) | 0.878 (+3.78%) | **0.910 (+7.57%)** |
| **Recall** | 0.762 | 0.784 (+2.89%) | 0.778 (+2.10%) | 0.790 (+3.67%) | 0.780 (+2.36%) | 0.822 (+7.87%) | 0.796 (+4.46%) | **0.836 (+9.71%)** |
| **F1-score** | 0.802 | 0.823 (+2.62%) | 0.817 (+1.87%) | 0.828 (+3.24%) | 0.819 (+2.12%) | 0.859 (+7.11%) | 0.835 (+4.11%) | **0.871 (+8.60%)** |
